...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyter-jaeger-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10459&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyter-jaeger-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyter-jaeger` can be installed with:

```
conda install jupyter-jaeger
```

It is possible to list all of the versions of `jupyter-jaeger` available on your platform with:
